...
@section('content')
    ...
    <div class="card_style border p-3 main-cont">
        <x-title-component title="Educación" />
        ...
        <div class="row">
            <div class="col-12 col-md-6 mb-3">
                <ul class="list-group">
                    <x-list-component title="Bachillerato" place="Preparatoria Regional de Tepatitlan."
                        timeframe="2016 - 2019"> <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30"
                            viewBox="0 0 24 24">
                            <path fill="#d82d6c"
            ...
            <div class="col-12 col-md-6 mb-3">
                <ul class="list-group">
                    ...
                    <x-list-component title="Licenciatura" place="Centro Universiatrio de los Altos"
        ...
        <x-title-component title="Cursos o Certificaciones" />

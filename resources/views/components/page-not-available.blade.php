@props([
    ...
    'text' => '',
    'route' => 'home',
    'tooltip_text' => 'Regresar al inicio',
])



<div class="row cont-not-available p-4 my-4 align-items-center justify-content-center">
    ...
    <div class="d-flex justify-content-center">
        ...
        <a href="{{ route($route) }}" class="icon-tooltip" rel="noopener noreferrer" data-tooltip="{{ $tooltip_text }}">

            @if ($route === 'home')
                <svg  data-aos="fade-up" xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24">

        ...
        <div>
            ...
            <div class="col-12">
                ...
                <p class="sm-text-justify">
                    Cuento con más de 2 años de experiencia como Full Stack, participando en todas las etapas del desarrollo
                    de software: desde el análisis de requerimientos y el diseño de la arquitectura y la interfaz, hasta el
                    desarrollo tanto de frontend como de backend, la realización de pruebas, el despliegue en producción y
                    el mantenimiento de las aplicaciones.
                    <br>
                    Esta experiencia me permite crear soluciones web dinámicas, funcionales y adaptadas a las necesidades de
                    los usuarios.
                </p>
            </div>
        </div>
    ...
    document.addEventListener('DOMConteentLoaded', () => {
        ...
        document.querySelectorAll('.read-more-btn').forEach(btn => {
            btn.addEventListener('click', () => {
                ...
                const extras = list.querySelectorAll('.extra-feature');

                extras.forEach(item => item.classList.toggle('d-none'));

                btn.textContent =
                    btn.textContent.trim() === 'Leer más' ?
                    'Leer menos' :
                    'Leer más';
            });
        });
